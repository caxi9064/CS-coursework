...
int main(int argc, char* argv[])
{
    ...
    while(opt != 5) {
        ...
        switch(opt) {
            case 1: {
                CUBuildingNet.loadDefaultSetup();//adding buildings to list and printing 
                CUBuildingNet.printNetwork();//printing building names
                break;
            }
            ...
            case 3: {
                ...
                CUBuildingNet.transmitRoomInfo(s1);//print room info until receiver node is found
